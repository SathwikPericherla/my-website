...
export function ProjectCard({title,bio,image,link}) {
  return (
      ...
      <CardBody className="bg-white shadow-2xl relative group/card  dark:hover:shadow-2xl dark:shadow-gray-800 dark:hover:shadow-emerald-500/[0.1] dark:bg-gray-800 dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        ...
        <CardItem translateZ="100" className="w-full mt-4">
          <img
            ...
            height="1000"
            width="1000"
            className="h-60 w-full mb-4 object-cover rounded-xl group-hover/card:shadow-xl"
            alt="thumbnail"
          />
        </CardItem>
        </CardItem>
        <CardItem
          as="p"
          translateZ="60"
          className="text-neutral-500 text-sm max-w-sm mt-2 font-semibold text-justify dark:text-neutral-300"
        >
          {bio}
        </CardItem>
